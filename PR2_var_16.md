...
Обратите внимание, что часть уведомления формируется с помощью условного оператора!
...
Если значение {total_forecast_risk}/{total_students} * 100 превышает 50% — вывести "высокий риск по группе"
Если 20–50% — вывести "средний риск".
Если ниже 20% — вывести "низкий риск".
